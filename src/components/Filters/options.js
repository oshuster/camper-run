export const equipmentOptions = [
  { svgName: 'airConditioner', label: 'AC', dataId: 'airConditioner' },
  { svgName: 'transmision', label: 'Automatic', dataId: 'automatic' },
...
export const vehicleTypeOptions = [
  { svgName: 'camper1', label: 'Van', dataId: 'panelTruck' },
  { svgName: 'camper2', label: 'Fully Integrated', dataId: 'fullyIntegrated' },
  { svgName: 'camper3', label: 'Alcove', dataId: 'alcove' },
];
